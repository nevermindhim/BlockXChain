...
// transactions. There should only be a single implementation in BlockX. For
// the purposes of BlockX, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: BlockX will distribute the fees out to validators, so the structure
