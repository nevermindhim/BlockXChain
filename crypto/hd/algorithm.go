...
// SupportedAlgorithms defines the list of signing algorithms used on BlockX:
...
func EthSecp256k1Options() []keys.KeybaseOption {
	return []keys.KeybaseOption{
		keys.WithKeygenFunc(BlockXKeygenFunc),
...
// BlockXKeygenFunc is the key generation function to generate secp256k1 ToECDSA
// from ethereum.
func BlockXKeygenFunc(bz []byte, algo keys.SigningAlgo) (tmcrypto.PrivKey, error) {
